...
const thisNodeID = "node5"
const thisNodeIP = "10.5.0.15"
...
//             resolve(peerRole)
//         }
//         else if (testamentorsAddress.includes(thisNodeID)) {
//             peerRole = "Testamentor"
//             clearInterval(timer)
//             resolve(peerRole)
//         }
...
//         const localMachineIP = queryNodesResult.filter(e => e.ID === assetCurrent.currentNode)["0"].nodeIP
        ...
        if (peerRole == "Local_Machine") {
            ...
            console.log("\nInheritor node: " + inheritorIP)
            console.log("\nThis node is an Testamentor related to asset: " + assetID)
            testamentorWorkflow.testamentorWorkflow(thisNodeIP, localMachineIP, inheritorIP)
        }
