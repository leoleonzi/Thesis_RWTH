...
const thisNodeID = "node1"
const thisNodeIP = "10.5.0.11"
...
var timer = setInterval(function () {
    ...
    new Promise(function (resolve, reject) {
        ...
        if (peerRole == "Local_Machine") {
            ...
            localMachineWorkflow.localMachineWorkflow(thisNodeIP, testamentFileName, assetFileName, testamentorsNumber, assetID, thisNodeID)
        }
        
        else if (peerRole == "Inheritor") {
            console.log("\nThis node is an Inheritor related to asset: " + assetID)
            inheritorWorkflow.inheritorWorkflow(thisNodeIP, localMachineIP, testamentFileName, testamentorsNumber, assetCurrent.currentNode)
        }
