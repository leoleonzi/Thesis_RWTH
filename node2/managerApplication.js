...
const thisNodeID = "node2"
const thisNodeIP = "10.5.0.12"
...
var timer = setInterval(function () {
    ...
    try{var testamentorsAddress = assetCurrent.testamentors.slice(1, -1).split(",")
    ...
    new Promise(function (resolve, reject) {
        ...
        if (peerRole == "Local_Machine") {
            ...
            console.log("local machine: " + assetCurrent.currentNode)
            inheritorWorkflow.inheritorWorkflow(thisNodeIP, localMachineIP, testamentFileName, testamentorsNumber, assetFileName, assetID, assetCurrent.currentNode)
        }
        
        else if (peerRole == "Testamentor") {
            console.log("\nInheritor node: " + assetCurrent.inheritor)
            console.log("\nThis node is an Testamentor related to asset: " + assetID)
            testamentorWorkflow.testamentorWorkflow(thisNodeIP, localMachineIP, assetCurrent.inheritor)
        }
